...
export default function FAQ() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="mb-10">
        <span className="inline-flex items-center justify-center w-14 h-14 bg-warning-50 text-warning-600 rounded-2xl mb-4">
          <SectionIcon id="faq" className="w-7 h-7" />
        </span>
      ...
      <div className="bg-brand-50 rounded-2xl p-8 border border-brand-200 mt-12 text-center">
        ...
        <h2 className="font-heading font-semibold text-brand-800 text-lg mb-2">{t.ui.faq.stillHaveQuestionsHeading}</h2>
        <p className="text-sm text-neutral-600 max-w-md mx-auto leading-relaxed">
          {t.ui.faq.stillHaveQuestionsText}
        </p>
      </div>
